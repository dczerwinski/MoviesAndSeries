...
public class MovieActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        imageView.setImageResource(this.getResources().getIdentifier(movie.img_file,"drawable",this.getPackageName()));
