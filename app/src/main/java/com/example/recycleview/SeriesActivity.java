...
public class SeriesActivity extends AppCompatActivity {
    @BindView(R.id.collapsing_toolbar_layout_series)
    CollapsingToolbarLayout mCollapsingToolbarLayout;
    @BindView(R.id.gora_series)
    ImageView imageView;
    @BindView(R.id.recycle_series)
    RecyclerView mRecyclerView;
    @BindView(R.id.rezyser_series)
    TextView tv_rezyser;
    @BindView(R.id.app_bar_series)
    AppBarLayout mAppBarLayout;
    @BindView(R.id.toolbar_series)
    Toolbar mToolbar;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        imageView.setImageResource(this.getResources()
                .getIdentifier(series.img_file, "drawable", this.getPackageName()));

        final RecyclerAdapterSeries mRecyclerAdapterSeries =
                new RecyclerAdapterSeries(series, this);
        ...
        mRecyclerView.addOnScrollListener(new RecyclerView.OnScrollListener() {
            ...
            public void onScrolled(@NonNull RecyclerView recyclerView, int dx, int dy) {
                ...
                int firstCompletelyItemVisible =
